(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function t(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(r){if(r.ep)return;r.ep=!0;const o=t(r);fetch(r.href,o)}})();function c(e){let n=document.createElement("div");n.className="card";let t=document.createElement("a");return t.href=e.homepage!=null&&e.homepage!=""&&e.homepage!="null"&&e.homepage!="undefined"&&e.homepage.includes("https://")?e.homepage:e.html_url,t.target="_blank",t.title=e.name,t.innerHTML=`
  <div>
    ...
    <main></main>`,document.querySelector("main").appendChild(l),document.getElementById("search").addEventListener("input",n=>{let t=document.createElement("div"),i=n.target.value;s.filter(o=>o.name.toLowerCase().includes(i.toLowerCase())).forEach(o=>{t.appendChild(c(o))}),document.querySelector("main").innerHTML="",document.querySelector("main").appendChild(t)})});
