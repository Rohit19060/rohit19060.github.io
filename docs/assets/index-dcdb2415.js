(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function o(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(r){if(r.ep)return;r.ep=!0;const n=o(r);fetch(r.href,n)}})();function c(e){let t=document.createElement("a");return t.href=e.homepage!=null&&e.homepage!=""&&e.homepage!="null"&&e.homepage!="undefined"&&e.homepage.includes("https://")?e.homepage:e.html_url,t.target="_blank",t.className="card",t.title=e.name,t.innerHTML=`
  <div>
    ...
    <main></main>`,document.querySelector("main").appendChild(l),document.getElementById("search").addEventListener("input",t=>{let o=document.createElement("div"),a=t.target.value;s.filter(n=>n.name.toLowerCase().includes(a.toLowerCase())).forEach(n=>{o.appendChild(c(n))}),document.querySelector("main").innerHTML="",document.querySelector("main").appendChild(o)})});
